...
import mobile.app.android.myavuzbahceci.weatherforecast.business.interactors.fullweather.GetCurrentWeatherByCityName
...
class GetCurrentWeatherWithCityNameTest {
    ...
    // system in test
    private lateinit var getCurrentWeatherByCityName: GetCurrentWeatherByCityName
    ...
    */
    @Test
    fun getCurrentWeatherWithCityNameInsertCache(): Unit = runBlocking {
        ...
        assert(fakeCurrentWeatherDao.getCurrentWeatherWithCityName(CITY_NAME) == null)

        val flowItems = getCurrentWeatherByCityName.execute(CITY_NAME, true).toList()
    ...
    @Test
    fun getCurrentWeatherFromNetwork_emitHttpError(): Unit = runBlocking {
